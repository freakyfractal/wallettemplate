package wallettemplate.wallets.bitcoin.controls;
...
import wallettemplate.wallets.bitcoin.utils.GuiUtils;
...
public class ClickableBitcoinAddress extends AnchorPane {
    ...
    public String uri() {
        return BitcoinURI.convertToBitcoinURI(getAddress(), null, Bitcoin.APP_NAME, null);
    }
    ...
    protected void showQRCode(MouseEvent event) {
        ...
        final Bitcoin.OverlayUI<ClickableBitcoinAddress> overlay = Bitcoin.instance.overlayUI(pane, this);
