package wallettemplate.wallets.bitcoin;
...
import wallettemplate.wallets.bitcoin.controls.ClickableBitcoinAddress;

import java.math.BigInteger;
import java.util.Date;

import static wallettemplate.wallets.bitcoin.Bitcoin.bitcoin;
import static wallettemplate.wallets.bitcoin.utils.GuiUtils.checkGuiThread;
...
public class BitcoinController {
    ...
    public void onBitcoinSetup() {
        ...
        addressControl.setAddress(bitcoin.wallet().getKeys().get(0).toAddress(Bitcoin.params).toString());
        refreshBalanceLabel();
    }

    public void sendMoneyOut(ActionEvent event) {
        // Hide this UI and show the send money UI. This UI won't be clickable until the user dismisses send_money.
        Bitcoin.instance.overlayUI("send_bitcoin.fxml");
    }
    ...
    public class ProgressBarUpdater extends DownloadListener {
        ...
        protected void doneDownload() {
            super.doneDownload();
            Platform.runLater(BitcoinController.this::readyToGoAnimation);
        }
    }
