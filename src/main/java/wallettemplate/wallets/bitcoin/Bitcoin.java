...
import static wallettemplate.wallets.bitcoin.utils.GuiUtils.*;

public class Bitcoin extends Application {
    public static String APP_NAME = "Bitcoin-testnet";

    public static String COIN_NAME = "bitcoin-testnet";
    public static String WALLET_NAME = "default";
    public static String USER_DIR = ".";

    public static NetworkParameters params = TestNet3Params.get();
    public static WalletAppKit bitcoin;
    public static Bitcoin instance;
    ...
    private void init(Stage mainWindow) throws IOException {
        ...
        URL location = getClass().getResource("bitcoin.fxml");
        FXMLLoader loader = new FXMLLoader(location);
        mainUI = loader.load();
        BitcoinController controller = loader.getController();
        ...
        bitcoin = new WalletAppKit(params, new File(USER_DIR+"/"+COIN_NAME), COIN_NAME+"-"+WALLET_NAME);
