package wallettemplate.wallets.dogecoin.controls;
...
//
// javac -cp $HOME/.m2/repository/net/glxn/qrgen/1.3/qrgen-1.3.jar:$HOME/.m2/repository/de/jensd/fontawesomefx/8.0.0/fontawesomefx-8.0.0.jar:../../../target/classes:../../../../core/target/bitcoinj-0.12-SNAPSHOT.jar -d ../../../target/classes/ -source 1.7 -target 1.7 info.bitcoinmonk.wallettemplate/wallettemplate.wallets.bitcoin/ClickableBitcoinAddress.java
 ...
 * that shows a QRcode.
 */
public class ClickableDogecoinAddress extends AnchorPane {
    ...
    public ClickableDogecoinAddress() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("dogecoin_address.fxml"));
            loader.setRoot(this);
    ...
    public String uri() {
        return BitcoinURI.convertToBitcoinURI(getAddress(), null, Dogecoin.APP_NAME, null);
    }
    ...
    protected void showQRCode(MouseEvent event) {
        ...
        final Dogecoin.OverlayUI<ClickableDogecoinAddress> overlay = Dogecoin.instance.overlayUI(pane, this);
